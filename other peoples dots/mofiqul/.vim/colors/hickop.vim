...
exe "hi Folded"      .s:v.'fg='.s:gr1.s:v.'bg='.s:gr1
exe "hi FoldColumn"  .s:v.'fg='.s:gr1.s:v.'bg='.s:gr1
...
exe "hi TabLine"     .s:v.'fg='.s:gr1.s:v.'bg='.s:gr1.s:v.'=NONE'
exe "hi TabLineSel"  .s:v.'fg=fg'    .s:v.'bg=bg'    .s:v.'=NONE'
exe "hi TabLineFill" .s:v.'fg=bg'    .s:v.'bg='.s:gr1.s:v.'=NONE'
