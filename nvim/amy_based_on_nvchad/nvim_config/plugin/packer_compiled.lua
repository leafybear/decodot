...
_G.packer_plugins = {
  ...
  ["galaxyline.nvim"] = {
    ...
    loaded = true,
    path = "/home/amy/.local/share/nvim/site/pack/packer/start/galaxyline.nvim"
  },
  ...
  ["popup.nvim"] = {
    loaded = true,
    path = "/home/amy/.local/share/nvim/site/pack/packer/start/popup.nvim"
  },
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Telescope lua require("packer.load")({'telescope-fzf-native.nvim', 'telescope-media-files.nvim'}, { cmd = "Telescope", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
